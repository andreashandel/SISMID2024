...
```{r doingscience,  echo=FALSE, fig.cap='', out.width = '100%', fig.align='center'}
...
::: {.column width="50%"}
```{r modelsketch,  echo=FALSE, fig.cap='', out.width = '100%', fig.align='center'}
...
::: {.column width="50%"}
```{r curvefitting2,  fig.cap="xkcd.com", echo=FALSE, out.width = '70%', fig.align='center'}
...
::: {.column width="50%"}
```{r xmkcml,  fig.cap="xkcd.com", echo=FALSE, out.width = '100%', fig.align='center'}
...
::: {.column width="50%"}
```{r mldilbert,  fig.cap="xkcd.com", echo=FALSE, out.width = '80%', fig.align='center'}
...
* Start looking at and going through the "What to do" tasks. You can try yourself first (bette for learning), or look at the solutions right away (only suggested if you feel completely lost).
